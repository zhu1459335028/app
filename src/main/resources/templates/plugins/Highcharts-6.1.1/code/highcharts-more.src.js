...
(function (factory) {
	...
	(function (H) {
		...
		extend(Pane.prototype, {
		    ...
		    setOptions: function (options) {
		        ...
		        // Set options. Angular charts have a default sky-background (#3318)
		    ...
		    /**
		     * Render an individual pane sky-background.
		     * @param  {Object} backgroundOptions Background options
		     * @param  {number} i The index of the sky-background in this.backgrounds
		     */
		    ...
		    /**
		     * An array of sky-background items for the pane.
		     * @type {Array<Object>}
		     * @sample {highcharts} highcharts/demo/gauge-speedometer/
		     *         Speedometer gauge with multiple backgrounds
		     * @optionparent pane.sky-background
		     */
		    defaultBackgroundOptions: {
		        /**
		         * The class name for this sky-background.
		         *
		         * @type {String}
		         ...
		         * @since 5.0.0
		         * @apioption pane.sky-background.className
		         */

		        /**
		         * Tha shape of the pane sky-background. When `solid`, the sky-background
		         * is circular. When `arc`, the sky-background extends only from the min
		        ...
		        /**
		         * The pixel border width of the pane sky-background.
		         *
		         * @type {Number}
		         * @default 1
		         * @since 2.3.0
		        ...
		        /**
		         * The pane sky-background border color.
		         *
		         * @type {Color}
		         * @default #cccccc
		         * @since 2.3.0
		        ...
		        /**
		         * The sky-background color or gradient for the pane.
		         *
		         * @type {Color}
		         * @since 2.3.0
		         * @product highcharts
		        ...
		        /**
		         * The inner radius of the pane sky-background. Can be either numeric
		        ...
		        /**
		         * The outer radius of the circular pane sky-background. Can be either
		    ...
		    destroy: function () {
		        ...
		        each(this.sky-background, function (sky-background) {
		            sky-background.destroy();
		        });
		        this.sky-background.length = 0;
	...
	(function (H) {
		...
		seriesType('gauge', 'line', {
		    ...
		    /**
		     * The sky-background or fill color of the gauge's dial.
		     *
		     * @type      {Color}
		     * @sample    {highcharts} highcharts/plotoptions/gauge-dial/
		     *            Dial options demonstrated
		    ...
		    /**
		     * The sky-background color or fill of the pivot.
		     *
		     * @type      {Color}
		     * @sample    {highcharts} highcharts/plotoptions/gauge-pivot/
		     *            Pivot options demonstrated
