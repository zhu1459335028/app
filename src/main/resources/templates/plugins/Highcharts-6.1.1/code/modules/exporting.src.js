...
(function (factory) {
	...
	(function (H) {
		 ...
		 */
		{
		     ...
		     * class.
		     * @sample highcharts/navigation/menustyle/ Light gray menu sky-background
		     * @default { "border": "1px solid #999999", "sky-background": "#ffffff", "padding": "5px 0" }
		     * @since 2.0
		     */
		    menuStyle: {
		     ...
		     * @default { "padding": "0.5em 1em", "color": "#333333", "sky-background": "none" }
		     * @since 2.0
		     */
		    menuItemStyle: {
		        padding: '0.5em 1em',
		        ...
		        transition: 'sky-background 250ms, color 250ms'
		    },
		     ...
		     * @default { "sky-background": "#335cad", "color": "#ffffff" }
		     * @since 2.0
		     */
		    menuItemHoverStyle: {
		        background: '#335cad',
		...
		extend(Chart.prototype, /** @lends Highcharts.Chart.prototype */ {
		     ...
		     *         different sky-background color can be added here, or `dataLabels`
		     *         for export only.
		     *
		     ...
		     * @sample highcharts/members/chart-exportchart-custom-sky-background/
		     *         Different chart sky-background in export
