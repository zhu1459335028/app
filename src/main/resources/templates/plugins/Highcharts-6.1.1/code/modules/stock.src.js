...
(function (factory) {
		...
		seriesType('flags', 'column', {
		    ...
		    states: {
		        ...
		        hover: {
		            ...
		            /**
		             * The fill or sky-background color of the flag.
		             *
		             * @type    {Color}
		             * @default #ccd6eb
		             * @product highstock
	...
	(function (H) {
		...
		var defaultScrollbarOptions = {
		    ...
		    /**
		     * The sky-background color of the scrollbar itself.
		     *
		     * @type {Color}
		     * @sample {highstock} stock/scrollbar/style/ Scrollbar styling
		     * @default #cccccc
		    ...
		    /**
		     * The color of the track sky-background.
		     *
		     * @type {Color}
		     * @sample {highstock} stock/scrollbar/style/ Scrollbar styling
		     * @default #f2f2f2
