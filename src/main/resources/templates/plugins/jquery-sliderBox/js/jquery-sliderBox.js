...
;(function($) {
    $.fn.slideBox = function(options) {
        ...
        var init = function(){
            ...
            // wrapper.width(li_width).height(li_height);
            lis.width(li_width).height(li_height);
            if (settings.direction == 'left') {
                ul.width(li_num * li_width);
            } else {
                ul.height(li_num * li_height);
            }
        ...
        //开始轮播
        var start = function() {
            var active = ul.find('li.active'), active_a = active.find('a'), offset = "", param = null;
